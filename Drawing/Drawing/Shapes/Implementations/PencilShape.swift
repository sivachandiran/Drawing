...
public struct PencilLineSegment: Codable, Equatable {
...
class PencilShape: Shape, ShapeWithStrokeState, ShapeSelectable {
    private enum CodingKeys: String, CodingKey {
      case id, isFinished, strokeColor, start, strokeWidth, segments, isEraser, type, transform
    }

    public static let type: String = "Pencil"
    ...
    public var segments: [PencilLineSegment] = []
    ...
    public required init(from decoder: Decoder) throws {
      ...
      segments = try values.decode([PencilLineSegment].self, forKey: .segments)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(PencilShape.type, forKey: .type)
    ...
    public func add(segment: PencilLineSegment) {
    ...
    private func render(in context: CGContext, onlyLast: Bool = false) {
      ...
      var lastSegment: PencilLineSegment?

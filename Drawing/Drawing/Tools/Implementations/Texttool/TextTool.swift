...
public class TextTool: NSObject, DrawingTool {
  ...
  private weak var shapeUpdater: DrawingViewShapeUpdating?
  ...
  public func activate(shapeUpdater: DrawingViewShapeUpdating, context: ToolOperationContext, shape: Shape?) {

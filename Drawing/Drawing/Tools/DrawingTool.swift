...
public protocol DrawingTool: AnyObject {
  ...
  /**
   ...
   - Parameters:
     - shapeUpdater: An object which you may inform of out-of-band shape updates.
       Normally, `DrawingView` only checks for changes during tool operations,
   ...
   */
  func activate(shapeUpdater: DrawingViewShapeUpdating, context: ToolOperationContext, shape: Shape?)
